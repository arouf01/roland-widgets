...
const createFuhrungskraftTableTable = (
  fuhrungskraftData,
  ...
  let StornoEffektiv = utils.getStornoEffektiv(Storno_effektiv) || 0.0;
      ...
      <table class="w-full mb-6 border border-collapse border-gray-300">
        <tbody>
          ...
          <tr class="border-b">
            ...
            <td class="text-right px-4">${getStornoreserveinFK}%</td>
            <td></td>
            <td class="text-right px-4"> - ${parseFloat(
              sumStorno || 0.0
            ).toFixed(2)}</td>
...
export { createFuhrungskraftTableTable };
